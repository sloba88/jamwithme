<% if (rc.gd$email) { %>
    <div class="col-xs-6 col-sm-4 col-lg-3 musician-box-container invite-friend-box" data-email="<%- rc.gd$email[0].address.toLowerCase() %>" data-name="<%- rc.title.$t.toLowerCase() %>">
